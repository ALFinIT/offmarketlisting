...
const LISTINGS: ListingItem[] = [
  {
    ...
    isNew: true,
    cit: true,
    img: "/markets/istanbul/1/img1.jpeg",
    price: "1.45M",
    priceFull: "1,450,000",
    loc: "Gurpinar, Beylikduzu",
    title: "Bosphorus-View Villa with Private Dock",
    sqm: "680",
    beds: "5",
    baths: "4",
    badge: "Istanbul - Gurpinar",
    eyebrow: "Istanbul - Bosphorus Waterfront",
    fullLoc: "Gurpinar, Beylikduzu, Istanbul",
    desc: "An exceptional private villa commanding sweeping Bosphorus panoramas from its position above the Gurpinar coastline. Designed by a renowned Turkish-Italian architect, this residence balances Ottoman heritage with contemporary European interiors. Hand-laid marble, reclaimed walnut joinery, and floor-to-ceiling glazing throughout. The grounds include a 25-metre infinity pool, landscaped terraces descending to a private dock, and a detached guest pavilion. Never listed publicly.",
    context:
      "Istanbul coastal corridor has seen consistent appreciation of 12-18% annually in premium residential stock. The Gurpinar-Beylikduzu waterfront remains one of the city last underdeveloped premium stretches. Full TAPU title deed included. Turkish citizenship eligibility confirmed.",
    citTag: "Turkish citizenship eligible",
    amenities: [
      "Private Dock & Boat Mooring",
      "25m Infinity Pool",
      "Bosphorus Panorama",
      "Home Cinema Room",
      "Wine Cellar",
    ...
    imgs: [
       "/markets/istanbul/1/img1.jpeg",
  "/markets/istanbul/1/img2.jpeg",
  "/markets/istanbul/1/img3.jpeg",
    ],
    video: "/markets/istanbul/1/video1.mp4",
  },
  // {
  //   id: "ist2",
  //   type: "Penthouse",
  ...
  //   priceFull: "890,000",
  //   loc: "Nisantasi, Sisli",
  //   title: "Sky Residence with Terrace, Nisantasi",
  //   sqm: "320",
  //   beds: "3",
  //   baths: "3",
  //   badge: "Istanbul - Nisantasi",
  //   eyebrow: "Istanbul - Nisantasi",
  //   fullLoc: "Nisantasi, Sisli, Istanbul",
  //   desc: "A spectacular top-floor penthouse in Nisantasi, Istanbul most refined residential district. Three generous bedrooms, each with bespoke fitted wardrobes and en-suite bathrooms. The wraparound terrace offers uninterrupted city and partial Bosphorus views. Concierge building, valet parking. Furnished to a bespoke standard by a Milan-based interior studio.",
  //   context:
  //     "Nisantasi consistently commands the highest per-square-metre prices in the European side of Istanbul. The district attracts sophisticated domestic and international buyers seeking proximity to luxury retail, dining, and cultural institutions. Values have been resilient through all market cycles.",
  //   citTag: "Turkish citizenship eligible",
  //   amenities: [
  //     "Wraparound Terrace",
  //     "City & Bosphorus Views",
  //     "Concierge Building",
  //     "Valet Parking",
  ...
  //   priceFull: "3,200,000",
  //   loc: "Bebek, Besiktas",
  //   title: "Historic Waterfront Yali, Bebek",
  //   sqm: "1100",
  //   beds: "7",
  //   baths: "6",
  //   badge: "Istanbul - Bebek",
  //   eyebrow: "Istanbul - Bosphorus Yali",
  //   fullLoc: "Bebek, Besiktas, Istanbul",
  //   desc: "A rare Bosphorus waterfront yali dating to the late Ottoman period, comprehensively restored to museum standard while incorporating every modern amenity. Seven bedrooms, six bathrooms, a private boathouse, and 38 metres of direct waterfront on the European shore of the Bosphorus. One of fewer than twelve such properties available in private hands. Truly irreplaceable.",
  //   context:
  //     "Bosphorus yali represent the most finite category of real estate in Turkey. There has been no new supply in over a century. The combination of historical significance, waterfront positioning, and extreme scarcity creates a market entirely insulated from macro headwinds. Values have appreciated at 22% CAGR over the past decade.",
  //   citTag: "Premium asset - enquire for details",
  //   amenities: [
  //     "38m Direct Bosphorus Frontage",
  //     "Private Boathouse",
  //     "Ottoman Period Architecture",
  //     "Museum-Grade Restoration",
  //     "7 Principal Bedrooms",
  //     "Landscaped Waterfront Gardens",
  //     "Private Jetty",
  //     "Guest Wing",
  //     "Library & Study",
  //     "Original Marble Hammam",
  //     "Caretaker Cottage",
  //     "Underground Cellar",
  //   ],
  //   meta: [
  //     ["Property Type", "Historic Yali"],
  //     ["Year Built", "1890 (Restored 2020)"],
  //     ["Frontage", "38 metres"],
  //     ["Title Deed", "Full TAPU"],
  //     ["Citizenship", "Enquire"],
  //     ["Condition", "Turnkey"],
  ...
  //     "https://images.unsplash.com/photo-1588880331179-bc9b93a8cb5e?w=1600&q=85",
  //     "https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=1600&q=85",
  //     "https://images.unsplash.com/photo-1598928506311-c55ded91a20c?w=1600&q=85",
      ...
      <main>
        <nav id="nav" className={isScrolled ? "scrolled" : ""}>
          ...
          <div className="nav-center">
            ...
            <span className="nav-market-name">Istanbul</span>
          </div>
        ...
        <div className="assurance-bar" style={{ marginTop: "72px" }}>
          <div className="assur-item">Verified Due Diligence</div>
          <div className="assur-item">Private Listings Only</div>
          <div className="assur-item">NDA on Request</div>
          <div className="assur-item">Response Within 24h</div>
          <div className="assur-item">Full TAPU Guaranteed</div>
        </div>

        <div className="market-band">
          <div>
            <div className="band-eyebrow">Our Markets - Istanbul</div>
            <h1 className="band-title">
              Istanbul
              <br />
              <em>Private</em> Real Estate
            </h1>
            <p className="band-sub">Bosphorus Waterfront - Nisantasi - Bebek - Gurpinar</p>
          </div>
          <div className="band-stats">
            <div className="band-stat">
              <div className="band-stat-num">12-18%</div>
              <div className="band-stat-lbl">Annual Appreciation</div>
            </div>
            <div className="band-stat">
              <div className="band-stat-num">4-6%</div>
        ...
        <section className="listings-section">
          <div className="filter-bar">
            ...
            <div className="filter-count">Showing {visibleListings.length} private listings - Istanbul</div>
          </div>
          ...
          {selectedListing ? (
            <>
              ...
              <div className="dp-foot">
                <div className="dp-foot-l">Your private gateway to Turkey hidden real estate gems.</div>
                <div className="dp-foot-r">Listings verified - Due diligence included - TAPU guaranteed<br />Copyright 2026 Off-Market Listing Turkey - Private Real Estate</div>
              </div>
            </>
          ) : null}
        </div>
