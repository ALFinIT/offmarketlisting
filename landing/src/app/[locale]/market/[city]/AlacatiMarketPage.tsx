...
const LISTINGS: ListingItem[] = [
  {
    ...
    isNew: true,
    cit: false,
    img: "https://images.unsplash.com/photo-1588880331179-bc9b93a8cb5e?w=800&q=80",
    price: "980K",
    priceFull: "980,000",
    loc: "Alacati Village, Cesme",
    title: "Restored Stone Mansion, Alacati Village",
    sqm: "420",
    beds: "6",
    baths: "5",
    badge: "Alacati - Village Core",
    eyebrow: "Alacati - Cesme Peninsula",
    fullLoc: "Alacati Village, Cesme Peninsula, Izmir",
    desc: "A meticulously restored 19th-century stone mansion set on a corner plot in Alacati most sought-after cobblestone lane. Original vaulted ceilings and bougainvillea-draped courtyard preserved in full. Contemporary kitchen and bathrooms installed with zero compromise to the historic fabric. Steps from the wine-country strip and Cesme coastline. A singular property.",
    context:
      "Alacati has become Turkey benchmark for lifestyle-driven premium real estate. Values in the village core have risen over 35% since 2022, driven by international buyer demand. Renovation-quality stone mansions of this calibre rarely appear on the market.",
    citTag: "Exclusive off-market - Enquire for details",
    amenities: [
      "Vaulted Stone Ceilings",
      "Courtyard Garden",
      "Original Cobblestone Floors",
      "B&B Potential",
      "Wine Country Views",
      "Artisan Joinery",
      "Open Fireplace",
      ...
      "Irrigation Garden",
      "Private Parking",
      "Airbnb Licence Ready",
    ],
    meta: [
      ["Property Type", "Historic Mansion"],
      ["Year Built", "1887 (Restored 2021)"],
      ["Plot Area", "680 m"],
      ["Title Deed", "Full TAPU"],
      ["Citizenship", "Case-by-Case"],
      ["Condition", "Turnkey"],
    ],
    mstats: [
      ["35%", "Since 2022"],
      ...
      <main>
        <nav id="nav" className={isScrolled ? "scrolled" : ""}>
          ...
          <div className="nav-center">
            ...
            <span className="nav-market-name">Alacati</span>
          </div>
        ...
        <div className="market-band">
          <div>
            <div className="band-eyebrow">Our Markets - Alacati</div>
            <h1 className="band-title">
              Alacati
              <br />
              <em>Aegean</em> Real Estate
            </h1>
            <p className="band-sub">Cesme Peninsula - Wine Country - Ilica</p>
          </div>
          <div className="band-stats">
            <div className="band-stat">
              <div className="band-stat-num">30-35%</div>
              <div className="band-stat-lbl">Annual Appreciation</div>
            </div>
            <div className="band-stat">
              <div className="band-stat-num">6-9%</div>
              <div className="band-stat-lbl">Gross Rental Yield</div>
            </div>
            <div className="band-stat">
              <div className="band-stat-num">Lifestyle</div>
        ...
        <section className="listings-section">
          <div className="filter-bar">
            ...
            <div className="filter-count">Showing {visibleListings.length} private listings - Alacati</div>
          </div>
