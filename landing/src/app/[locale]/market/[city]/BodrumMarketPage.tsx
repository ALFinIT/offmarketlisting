...
const LISTINGS: ListingItem[] = [
  {
    ...
    isNew: true,
    cit: true,
    img: "https://images.unsplash.com/photo-1602088113235-229c19758e9f?w=800&q=80",
    price: "2.1M",
    priceFull: "2,100,000",
    loc: "Yalikavak",
    title: "Designer Villa with Marina Views, Yalikavak",
    sqm: "520",
    beds: "4",
    baths: "4",
    badge: "Bodrum - Yalikavak",
    eyebrow: "Bodrum - Yalikavak Marina",
    fullLoc: "Yalikavak, Bodrum Peninsula, Mugla",
    desc: "Positioned on an elevated hillside plot above Yalikavak Marina, this contemporary villa by award-winning studio Ege Architects delivers panoramic blue-water views from every principal room. Infinity pool cascading toward the sea, rooftop sun deck, and a private wine cave. Completely off the open market. Available through introduction only.",
    context:
      "Bodrum Yalikavak quarter has established itself as Turkey equivalent of Saint-Tropez. Superyacht traffic, international art events, and a growing roster of Michelin-level restaurants have cemented premium values. Villa stock at this level has less than 2% annual supply.",
    ...
    meta: [
      ["Property Type", "Designer Villa"],
      ["Year Built", "2022"],
      ["Plot Area", "1,800 m"],
      ["Title Deed", "Full TAPU"],
      ["Citizenship", "Eligible"],
      ["Condition", "Furnished & Ready"],
    ],
    mstats: [
    ...
    imgs: [
      "https://images.unsplash.com/photo-1602088113235-229c19758e9f?w=1600&q=85",
      "https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=1600&q=85",
      "https://images.unsplash.com/photo-1600011689032-8b628b8a8747?w=1600&q=85",
      "https://images.unsplash.com/photo-1601918774516-5543df9a6eaa?w=1600&q=85",
  ...
  },
  {
    ...
    priceFull: "1,350,000",
    loc: "Golkoy, Bodrum",
    title: "Aegean Seaview Estate, Golkoy",
    sqm: "380",
    beds: "4",
    baths: "3",
    badge: "Bodrum - Golkoy",
    eyebrow: "Bodrum - Golkoy",
    fullLoc: "Golkoy, Bodrum, Mugla",
    desc: "A beautifully proportioned seaview estate in the serene Golkoy district, set among mature pine woodland with direct Aegean sea glimpses. Generous living spaces, a 14m pool, and extensive alfresco terracing. Golkoy has attracted a discerning international community while retaining its village character.",
    context:
      "Golkoy represents excellent value relative to the Yalikavak market with comparable natural beauty and sea access. Strong holiday rental demand from the European market. Year-round residency is increasingly popular among remote-working internationals.",
    citTag: "Turkish citizenship eligible",
    amenities: [
      "Aegean Sea Views",
      "14m Pool",
      "Pine Woodland Setting",
      "Alfresco Terracing",
      "Guest House",
      "4 Bedrooms",
      "Fireplace",
      ...
      <main>
        <nav id="nav" className={isScrolled ? "scrolled" : ""}>
          ...
          <div className="nav-center">
            ...
            <span className="nav-market-name">Bodrum</span>
          </div>
        ...
        <div className="market-band">
          <div>
            <div className="band-eyebrow">Our Markets - Bodrum</div>
            <h1 className="band-title">
              Bodrum
              <br />
              <em>Peninsula</em> Real Estate
            </h1>
            <p className="band-sub">Yalikavak - Turkbuku - Golturkbuku - Golkoy</p>
          </div>
          <div className="band-stats">
            <div className="band-stat">
              <div className="band-stat-num">20-25%</div>
              <div className="band-stat-lbl">Annual Appreciation</div>
            </div>
            <div className="band-stat">
              <div className="band-stat-num">5-7%</div>
        ...
        <section className="listings-section">
          <div className="filter-bar">
            ...
            <div className="filter-count">Showing {visibleListings.length} private listings - Bodrum</div>
          </div>
